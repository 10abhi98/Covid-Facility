      ...
      <>
        <div id='loginPlace' className='float-right'>
          <button
            id='logIn'
            className='button'
            onClick={() => this.props.history.push('/volunteer/login')}
          >
            Log In
          </button>
        </div>
          ...
          <div className='row ml-md-5'>
            <div className='col-md-5 pl-md-5'>
              ...
              <form>
                ...
                <small className='form-text'>{this.state.emailError}</small>
                <div className='form-group'>
                  <input
                    type='password'
                    name='userPassword'
                ...
                <small className='form-text'>{this.state.passError}</small>
                <div className='form-group'>
                  <input
                    type='number'
                    name='userContact'
